package hydraheadhunter.cmdstats.util.units.damage;
...
public class Heart implements iUnit {
	private static final String UNIT_TYPE = "damage";
	private static final String UNIT_KEY = "heart";
	public static final double CONVERSION_FACTOR = 2;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"heart", "hearts"} ) );
