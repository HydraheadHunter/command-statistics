...
public class SubChunkCube implements iUnit {
	private static final String UNIT_TYPE = "block";
	private static final String UNIT_KEY = "subchunk";
	public static final double CONVERSION_FACTOR = 4096;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"chunk_cube", "subchunk"} ) );
