...
public class MapLayer implements iUnit {
	private static final String UNIT_TYPE = "block";
	private static final String UNIT_KEY = "map_layer";
	public static final double CONVERSION_FACTOR = 16384;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"map", "maps" } ) );
