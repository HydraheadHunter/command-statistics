...
public class ShulkerChest implements iUnit {
	private static final String UNIT_TYPE = "inventory";
	private static final String UNIT_KEY = "chest.shulker";
	public static final double CONVERSION_FACTOR = 729;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"shulker_chest", "chest_of_shulkers", "sk_ch", "SkCh" } ) );
