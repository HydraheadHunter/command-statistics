...
public class Hopper implements iUnit {
	...
	public static final double CONVERSION_FACTOR = 5;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"hopper", "hoppers", "minecarft_hopper", "minecart_hoppers" } ) );
