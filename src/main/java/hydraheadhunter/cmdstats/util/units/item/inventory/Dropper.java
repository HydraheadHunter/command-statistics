...
public class Dropper implements iUnit {
	private static final String UNIT_TYPE = "inventory";
	private static final String UNIT_KEY = "dropper";
	public static final double CONVERSION_FACTOR = 9;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"dropper", "dispenser", "crafter", "droppers", "dispensers", "crafters" } ) );
