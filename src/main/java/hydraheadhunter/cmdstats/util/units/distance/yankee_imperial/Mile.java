...
public class Mile implements iUnit {
	private static final String UNIT_TYPE = "distance";
	private static final String UNIT_KEY = "mile";
	public static final double CONVERSION_FACTOR = 160934.4;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"mile", "miles", "mi" } ) );
