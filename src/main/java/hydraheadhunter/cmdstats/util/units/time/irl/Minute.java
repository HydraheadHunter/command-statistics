...
public class Minute implements iUnit {
	private static final String UNIT_TYPE = TIME;
	private static final String UNIT_KEY = "minute";
	public static final double CONVERSION_FACTOR = 1200;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"minute", "minutes", "m"} ) );
