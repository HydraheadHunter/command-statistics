...
public class Hour implements iUnit {
	private static final String UNIT_TYPE = TIME;
	private static final String UNIT_KEY = "hour";
	public static final double CONVERSION_FACTOR = 72000;
	public static final String TRANSLATION_KEY = join(KEY_ROOT,UNIT_KEY);
	
	public static final ArrayList<String> EQ_UNITS= new ArrayList<>( List.of(new String[] {"hour", "hours", "h"} ) );
