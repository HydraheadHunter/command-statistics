...
/* /stats projec                               $ */                                    .requires( (source)  -> { return source.hasPermissionLevel(PROJECT_OP); } )
/* /stats store  @p                              */    .then(                CommandManager.argument(TARGETS     ,          EntityArgumentType.players())
...
/* /stats projec @p start [N]                    */                                        .executes( (context) -> {return executeProjectSTART( context, StringArgumentType.getString(context,PROJECT_NAME));} )
...
/* /stats projec @p stop  [N]                    */                                        .executes( (context) -> {return executeProjectSTOP ( context, StringArgumentType.getString(context,PROJECT_NAME));} )
...
/* /stats projec @p pause [N]                    */                                        .executes( (context) -> {return executeProjectPAUSE ( context, StringArgumentType.getString(context,PROJECT_NAME));} )
...
/* /stats query                                $ */                                        .requires( (source)  -> { return source.hasPermissionLevel(PROJECT_OP); } )
...
/* /stats pjt @p query [N] mined   [B]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_MINED*EN_PROJECT); } )
...
/* /stats pjt @p query [N] crafted [I]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_CRAFTED*EN_PROJECT); } )
...
/* /stats pjt @p query [N] used    [I]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_USED*EN_PROJECT); } )
...
/* /stats pjt @p query [N] broken  [I]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_BROKEN*EN_PROJECT); } )
...
/* /stats pjt @p query [N] picked  [I]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_PICKED_UP*EN_PROJECT); } )
...
/* /stats pjt @p query [N] dropped [I]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_DROPPED*EN_PROJECT); } )
...
/* /stats pjt @p query [N] killed  [E]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_KILLED*EN_PROJECT); } )
...
/* /stats pjt @p query [N] killedB [E]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_KILLED_BY*EN_PROJECT); } )
...
/* /stats pjt @p query [N] custom  [i]         % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_QUERY*EN_CUSTOM*EN_PROJECT); } )
...
/* /stats pjt @p store [N] mined   [B] [score] % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_MINED*EN_PROJECT); } )
...
/* /stats pjt @p store [N] crafted [I] [score] % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_CRAFTED*EN_PROJECT); } )
...
/* /stats pjt @p store [N] used    [I] [score] % */                                             .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_USED*EN_PROJECT); } )
...
/* /stats pjt @p store [N] broken  [I] [score] % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_BROKEN*EN_PROJECT); } )
...
/* /stats pjt @p store [N] picked  [I] [score] % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_PICKED_UP*EN_PROJECT); } )
...
/* /stats pjt @p store [N] dropped [I] [score] % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_DROPPED*EN_PROJECT); } )
...
/* /stats pjt @p store [N] killed  [E] [score] % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_KILLED*EN_PROJECT); } )
...
/* /stats pjt @p store [N] killedB [E] [score] % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_KILLED_BY*EN_PROJECT); } )
...
/* /stats pjt @p store [N] custom  [i] [score] % */                                        .executes( (context) -> { return decodeExecutionMode( context, EN_STORE*EN_CUSTOM*EN_PROJECT); } )
...
// /statistics store @p stat_ype stat objective <EXECUTE>
     ...
     private static int executeProjectPAUSE( CommandContext<ServerCommandSource> context, String projectName){
          return -2;
     }
